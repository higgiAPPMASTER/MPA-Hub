...
nav{position:fixed;top:0;width:100%;background:rgba(10,10,10,.95);backdrop-filter:blur(12px);border-bottom:1px solid #1c1c1c;z-index:100;padding:0 32px;height:68px;display:flex;align-items:center;justify-content:space-between}
.logo{font-family:'Playfair Display',serif;font-size:20px;font-weight:900;color:#f59e0b;letter-spacing:.02em}
.logo span{color:#fff}
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;padding-top:88px">
...
<div style="max-width:1000px;margin:0 auto;padding:100px 24px 60px">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:20px">
    ...
    <div class="card" style="text-align:center;display:flex;flex-direction:column;gap:14px;align-items:center">
      ...
      <p style="color:#6b7280;font-size:12px;line-height:1.6">Shots on goal picks with live FanDuel sportsbook lines.</p>
      <a href="https://nhl-shots-picks.onrender.com" target="_blank" class="btn" style="width:100%;text-align:center">🎯 OPEN PICKS</a>
    </div>
    <div class="card" style="text-align:center;display:flex;flex-direction:column;gap:14px;align-items:center">
      <div style="font-size:52px">🏀</div>
